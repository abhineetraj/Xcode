...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ParseMutableClientConfiguration.applicationId = "8bf008b50c8dd102c5b995050825eaadfb321c99"
            ParseMutableClientConfiguration.clientKey = "d4089e9aaeb2949b41dc6e46448a49f5f1da87aa"
            //ParseMutableClientConfiguration.applicationId = "myappid"
            //ParseMutableClientConfiguration.clientKey = "mymasterkey"
            
            
            ParseMutableClientConfiguration.server = "http://ec2-54-210-6-14.compute-1.amazonaws.com:80/parse"
        })
